...
implements DetailFragment.FragmentListener { // Implement the interface and it's methods
    ...
    // This method in the containing Activity receives a message from
    // the Fragment via the callback method
    @Override
    public void onFragmentFinish(String firstName, String lastName, int age) {

        // Output the information that's passed in
